<?php
include("../function/search_admin_competition_fxn.php");


if (isset($_GET["searchquery"])){
    $searchquery = htmlspecialchars($_GET["searchquery"]);

    $searchcomp = SearchAdminCompetition($searchquery);

    if (empty($searchcomp)){
        echo "<tr><td colspan='5'>No Competition Found</td></tr>";
    }
    else{
        foreach($searchcomp as $comp) {
                echo "<tr>";
                ...
                echo "<td>
                        ...
                        <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-trash-fill' viewBox='0 0 16 16' href = ''>
